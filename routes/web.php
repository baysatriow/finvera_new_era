...
Route::middleware('auth')->group(function () {
     ...
     * ------------------------------
     */
    Route::get('/register/step-2', [AuthController::class, 'showRegisterStep2'])
        ->name('register.step2');
    ...
    Route::get('/dashboard/ai-advice', [DashboardController::class, 'getAiAdvice'])
        ->name('dashboard.ai-advice');
     ...
     * ========================================================
     */
    Route::get('/kyc/verify', [KycController::class, 'create'])
        ->name('kyc.create');

    Route::post('/kyc/verify', [KycController::class, 'store'])
        ->name('kyc.store');
    ...
    Route::post('/bank/{id}/primary', [BankAccountController::class, 'setPrimary'])
        ->name('bank.primary');
    ...
    Route::get('/history', [LoanController::class, 'index'])
        ->name('history');
    ...
    Route::get('/installments/{id}/pay', [InstallmentController::class, 'showPaymentPage'])
        ->name('installments.pay');

    Route::post('/installments/{id}/submit', [InstallmentController::class, 'submitPayment'])
        ->name('installments.submit');
    ...
    Route::get('/notifications/{id}/read', [NotificationController::class, 'show'])
    ...
    Route::prefix('admin')
        ...
        Route::post('/applications/{id}/approve', [AdminController::class, 'approve'])
            ->name('approve');

        Route::post('/applications/{id}/reject', [AdminController::class, 'reject'])
            ->name('reject');
        ...
        Route::post('/disbursement/verify/{id}', [AdminDisbursementController::class, 'verifyPayment'])
            ->name('disbursement.verify');
        ...
        Route::post('/banks/{id}/primary', [AdminBankController::class, 'setPrimary'])
            ->name('banks.primary');
